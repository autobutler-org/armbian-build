...
function extension_prepare_config__400_autobutler_image_defaults() {
	...
	: "${AUTOBUTLER_IMAGE_BINARY_URL:=https://github.com/autobutler-org/autobutler/releases/latest/download/autobutler_Linux_arm64.tar.gz}"
	...
	declare -g APPLIANCE_IMAGE_BINARY_URL="${AUTOBUTLER_IMAGE_BINARY_URL}"
